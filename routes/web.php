...
Route::get('/d/{department:slug}/', [ProductController::class, 'byDepartment'])->name('products.byDepartment');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['verified'])->group(function () {
        ...
        Route::get('/stripe/refresh', function () {
            return redirect()->route('dashboard')->with('error', 'Please complete your Stripe account setup.');
        })->name('stripe.account.refresh');
        Route::get('/stripe/return', function () {
            return redirect()->route('dashboard')->with('success', 'Your Stripe account is now connected!');
        })->name('stripe.account.return');
