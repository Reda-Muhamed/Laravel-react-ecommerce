<x-mail::message>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>Total</td>
                       <td>
                        {{ \Illuminate\Support\Number::currency($order->total_price?:0) }}
                       </td>
                    </tr>
                </tbody>
            </table>
    ...
    @endforeach
    <x-mail::subcopy>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde hic totam iusto aliquam esse a possimus reiciendis maxime minus omnis qui, dolores est amet aspernatur ut at, voluptates temporibus rem.
    </x-mail::subcopy>
    <x-mail::panel>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde hic totam iusto aliquam esse a possimus reiciendis maxime minus omnis qui, dolores est amet aspernatur ut at, voluptates temporibus rem.
    </x-mail::panel>
